...
We can use a histogram to observe the distribution of values in our data and
determine where breaks should go. We can use `breaks=` to tell `R` to use fewer
or more breaks or bins in our histogram. 
