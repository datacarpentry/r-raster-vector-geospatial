...
> >   geom_sf(data = plotLocations, aes(fill = soilTypeOr), 
> >           shape = 21, color = NA, show.legend = 'point') + 
> >   scale_color_manual(name = "Line Type", values = roadColors,
...
> >   ggtitle("Map of Study Area w/ Canopy Height Model", subtitle = "NEON Harvard Forest Field Site")
> >
> > ```
> {: .solution}
{: .challenge}
