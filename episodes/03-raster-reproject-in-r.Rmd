...
In the [Plot Raster Data in R](https://datacarpentry.org/organization-geospatial/02-raster-plot)
...
[a later episode](https://datacarpentry.org/organization-geospatial/04-raster-calculations-in-r/) and will see how to calculate 
...
[Plot Raster Data in R](https://datacarpentry.org/organization-geospatial/02-raster-plot)
