...
[vegetation and other ecological metrics](http://www.neonscience.org/science-design/collection-methods/terrestrial-organismal-sampling).
We would like to:
...
We will continue using the `sf` and `raster` libraries in this episode.
