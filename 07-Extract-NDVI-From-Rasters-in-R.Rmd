...
[raster data in R ]({{ site.baseurl }}Tutorials/Raster-Pheno-Series). It is also
part of a larger spatio-temporal 
[Data Carpentry Workshop ]({{ site.baseurl }}Workshops/Spatio-Temporal-Workshop)
that includes working with vector data in R 
[raster data in R ]({{ site.baseurl }}Tutorials/Vector-Pheno-Series) 
and tabular time series in R 
[raster data in R ]({{ site.baseurl }}Tutorials/Tabular-Time-Pheno-Series).
...
Obseravatory Network (NEON) also has a field site in Southern California
at the
...
larger greenness value. Is the vegetation truely senescent or gone or are these
...
values are not valid due to cloud cover. However, a theshold value may not 
always be sufficicient given 0.1 could be a valid NDVI value in some areas. This
