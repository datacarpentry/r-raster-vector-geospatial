...
modifies the histogram of colors in the image in order to increase contrast.

COLIN CREATE GRAPIC/ INSERT GRAPHIC OF STRECH FROM http://www.nrcan.gc.ca/earth-sciences/geomatics/satellite-imagery-air-photos/satellite-imagery-products/educational-resources/9389
...
``` {r challenge-code-NoData, echo=FALSE}
#1.
#view attributes
