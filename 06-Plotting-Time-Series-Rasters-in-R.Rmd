...
pixels that are more green, have a higher NDVI value. However, the labels for
eachraster tile are a bit clunky. 
...
#use level plot to create a nice plot with one legend and a 4x3 layout.
levelplot(NDVI_stack,
          layout=c(4, 3), #create a 4x3 layout for the data
