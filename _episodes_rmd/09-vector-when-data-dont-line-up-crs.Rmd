...
![Maps of the United States using data in different projections. Source: opennews.org](https://media.opennews.org/cache/06/37/0637aa2541b31f526ad44f7cb2db7b6c.jpg)
...
ggplot() +
    ...
    ggtitle("Map of Contiguous US State Boundaries", subtitle = "US Census Bureau Data")
```
...
ggplot() +
    ...
    geom_sf(data=point_HARV, shape=19, color="purple") +
    ggtitle("Map of Contiguous US State Boundaries", subtitle = "with Tower Location")
```
...
> >     ggtitle("Map of Northeastern US", subtitle = "With Fisher Tower Location - UTM Zone 18N") +
