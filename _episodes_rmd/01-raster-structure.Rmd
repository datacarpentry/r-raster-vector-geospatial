...
`raster` and `rgdal` packages. Make sure that you have these libraries loaded.
...
zone. Image source: Chrismurf at English Wikipedia, via Wikimedia Commons.
