...
of the plot. To show this, let's plot our `aoiBoundary` object with our vegetation plots.
...
When we attempt to plot the two layers together, `ggplot` sets the plot boundaries
...
> > ```{r}
> > ggplot() + 
> >   geom_sf(data = plot_locations_sp_HARV$geometry, color = "orange") +
> >   geom_sf(data = newPlot.Sp.HARV$geometry, color = "lightblue") +
