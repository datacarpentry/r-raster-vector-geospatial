...
> >
> > 2)
> >  The data contains latitude and longtitude. In WGS84, this corresponds
> >  to specification 4326. we will convert our new data to a spatial dataframe.
> >
> > ```{r}
> > newPlot.Sp.HARV <- st_as_sf(newplot_locations_HARV, coords = c("decimalLon", "decimalLat"), crs = "4326")
> > ```
> >
> > Next we'll add CRS information and confirm that the CRS for our new object is correct.
> >
> > ```{r}
> > st_crs(newPlot.Sp.HARV)<-st_crs(4326)
