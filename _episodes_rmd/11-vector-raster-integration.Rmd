...
To illustrate this, we will crop the Canopy Height Model (CHM) to only include the area of interest (AIO). Let's start by plotting the full extent of the CHM data and overlay where the AIO falls within it. The boundaries of the AIO will be colored blue, and we use `fill = NA` to make the area transparent.
...
```{r show-cropped-area}
CHM_HARV_Cropped_df <- raster::as.data.frame(CHM_HARV_Cropped, xy = TRUE)
