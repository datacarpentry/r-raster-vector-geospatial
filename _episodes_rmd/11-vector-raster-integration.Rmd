...
plot.locationsSp_HARV <- st_as_sf(plot.locations_HARV, 
...
plot(st_convex_hull(st_union(plot.locationsSp_HARV)),
     col="black",
     add=TRUE)

plot(st_convex_hull(aoiBoundary_HARV),
     add=TRUE,
     col="blue", 
     lwd=4)
...
plot(aoiBoundary_HARV$geometry, lwd=8, border="blue",
