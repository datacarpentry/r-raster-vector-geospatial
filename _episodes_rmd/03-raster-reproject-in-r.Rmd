...
questions: What do I do when rasters don't line up?
teaching: 20
exercises: 10
---
...
DTM_hill_HARV_df <- raster::as.data.frame(DTM_hill_HARV, xy = TRUE)
```
...
DTM_hill_HARV_2_df <- raster::as.data.frame(DTM_hill_UTMZ18N_HARV, xy = TRUE)
```
...
> > 
> > DSM_hill_SJER_df <- raster::as.data.frame(DTM_hill_UTMZ18N_SJER, xy = TRUE)
> > 
> > ggplot() +
