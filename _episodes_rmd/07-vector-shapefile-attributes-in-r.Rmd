...
## Load the Data
We will continue using the `sf`, `raster` and `ggplot2` packages in this episode. Make sure that you have these libraries loaded. We will
...
* `nrow()` - How number of features in the object
