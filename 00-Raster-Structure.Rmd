...
metadata about the file. We can view those tags before we open the data in `R` 
using the `GDALinfo()` function.
...
PROJECTION DISCUSSION - brief into to each with links out. 
