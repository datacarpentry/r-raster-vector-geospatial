...
~~~
Error in st_sf(x, ..., agr = agr, sf_column_name = sf_column_name): object 'utm18nCRS' not found
~~~
{: .error}
...
~~~
Error in st_union(lines_HARV): object 'lines_HARV' not found
~~~
{: .error}
...
~~~
Error in st_union(plot_locations_sp_HARV): object 'plot_locations_sp_HARV' not found
~~~
{: .error}
...
~~~
Error in st_convex_hull(aoi_boundary_HARV): object 'aoi_boundary_HARV' not found
~~~
{: .error}
