...
```
## Error in plot(DSM_HARV, col = col, breaks = brk, main = "Classified Elevation Map\nNEON Harvard Forest Field Site", : object 'DSM_HARV' not found
```
...
```
## Error in plot(DSM_HARV, main = "NEON Digital Surface Model\nHarvard Forest"): object 'DSM_HARV' not found
```
...
```
## Error in minValue(DSM_HARV): object 'DSM_HARV' not found
```
...
```
## Error in maxValue(DSM_HARV): object 'DSM_HARV' not found
```
...
```
## Error in plotRGB(RGB_stack, r = 1, g = 2, b = 3, axes = TRUE, main = "Raster With NoData Values\nRendered in Black"): object 'RGB_stack' not found
```
...
```
## Error in calc(RGB_stack, f): object 'RGB_stack' not found
```

```
## Error in plotRGB(newRGBImage, r = 1, g = 2, b = 3, axes = TRUE, main = "Raster With No Data Values\nNoDataValue= NA"): object 'newRGBImage' not found
```
...
```
## Error in hist(DSM_HARV, main = "Distribution of Digital Surface Model Values\n Histogram Default: 100,000 pixels\n NEON Harvard Forest", : object 'DSM_HARV' not found
```
...
```
## Error in ncell(DSM_HARV): object 'DSM_HARV' not found
```
...
```
## Error in hist(DSM_HARV, maxpixels = ncell(DSM_HARV), main = "Distribution of DSM Values\n All Pixel Values Included\n NEON Harvard Forest Field Site", : object 'DSM_HARV' not found
```
...
```
## Error in nlayers(DSM_HARV): object 'DSM_HARV' not found
```
